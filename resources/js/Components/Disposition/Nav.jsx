...
export default function Nav({ leftNavRef, setProfilPanel, setLeftNav, leftNav, profilPanel, icon }) {
    ...
    return (
        <nav className="bg-[#23252b] flex justify-between h-16 sticky top-0 z-50 border-b border-black">
            <div className="flex items-center h-full">
                ...
                <Link
                    href="/"
                    className="unselectable lexend text-[28px] text-[#ff5e00] hover:text-white hover:bg-[#14151a] h-full center px-4"
                >
                    RE:PLAY
                </Link>
            </div>
